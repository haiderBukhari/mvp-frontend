  ...
  const plans = [
    {
      name: "Free Version",
      price: "Free",
      description: "Complete booking automation platform for testing and development",
      features: [
        "Unlimited bookings",
    ...
    },
    {
      name: "Professional",
      price: "Coming Soon",
      description: "Enhanced features for growing media companies",
      features: [
        "Everything in Free",
      ...
      <div className="max-w-7xl mx-auto space-y-16">
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-medium tracking-tighter text-foreground">
            Simple pricing for booking automation
          </h2>
          <p className="text-muted-foreground text-lg">
            Start free and scale your media booking operations as you grow
          </p>
        </div>
